...
namespace BIT.Data.Services
{
    public class ConfigurationStringParser
    {
        ...
        Dictionary<string, ValuePair> propertyTable = new Dictionary<string, ValuePair>(StringComparer.InvariantCultureIgnoreCase);
        public string[] ExtractParts(string connectionString)
        {
        ...
        public ConfigurationStringParser()
        {
        }
        public ConfigurationStringParser(string connectionString)
            : this()
        {
